...
(function(G,q,k){typeof define==="function"&&define.amd?define(["jquery"],function(a){k(a,G,q);return a.mobile}):k(G.jQuery,G,q)})(this,document,function(G,q,k){(function(a,c,b,g){function e(a){for(;a&&typeof a.originalEvent!=="undefined";)a=a.originalEvent;return a}function d(b){for(var d={},e,f;b;){e=a.data(b,w);for(f in e)if(e[f])d[f]=d.hasVirtualBinding=true;b=b.parentNode}return d}function f(){y&&(clearTimeout(y),y=0);y=setTimeout(function(){E=y=0;C.length=0;z=false;F=true},a.vmouse.resetTimerDuration)}
function h(b,d,f){var c,h;if(!(h=f&&f[b])){if(f=!f)a:{for(f=d.target;f;){if((h=a.data(f,w))&&(!b||h[b]))break a;f=f.parentNode}f=null}h=f}if(h){c=d;var f=c.type,z,j;c=a.Event(c);c.type=b;h=c.originalEvent;z=a.event.props;f.search(/mouse/)>-1&&(z=x);if(h)for(j=z.length;j;)b=z[--j],c[b]=h[b];if(f.search(/mouse(down|up)|click/)>-1&&!c.which)c.which=1;if(f.search(/^touch/)!==-1&&(b=e(h),f=b.touches,b=b.changedTouches,f=f&&f.length?f[0]:b&&b.length?b[0]:g))for(h=0,len=u.length;h<len;h++)b=u[h],c[b]=f[b];
a(d.target).trigger(c)}return c}function j(b){var d=a.data(b.target,v);if(!z&&(!E||E!==d))if(d=h("v"+b.type,b))d.isDefaultPrevented()&&b.preventDefault(),d.isPropagationStopped()&&b.stopPropagation(),d.isImmediatePropagationStopped()&&b.stopImmediatePropagation()}function p(b){var f=e(b).touches,c;if(f&&f.length===1&&(c=b.target,f=d(c),f.hasVirtualBinding))E=K++,a.data(c,v,E),y&&(clearTimeout(y),y=0),A=F=false,c=e(b).touches[0],q=c.pageX,D=c.pageY,h("vmouseover",b,f),h("vmousedown",b,f)}function m(a){F||
...
a.data(b,w),d;if(b)for(d in b)if(b[d])return true;return false}function n(){}function k(b){var d=b.substr(1);return{setup:function(){r(this)||a.data(this,w,{});a.data(this,w)[b]=true;t[b]=(t[b]||0)+1;t[b]===1&&H.bind(d,j);a(this).bind(d,n);if(J)t.touchstart=(t.touchstart||0)+1,t.touchstart===1&&H.bind("touchstart",p).bind("touchend",l).bind("touchmove",o).bind("scroll",m)},teardown:function(){--t[b];t[b]||H.unbind(d,j);J&&(--t.touchstart,t.touchstart||H.unbind("touchstart",p).unbind("touchmove",o).unbind("touchend",
l).unbind("scroll",m));var e=a(this),f=a.data(this,w);f&&(f[b]=false);e.unbind(d,n);r(this)||e.removeData(w)}}}var w="virtualMouseBindings",v="virtualTouchID",c="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" "),u="clientX clientY pageX pageY screenX screenY".split(" "),x=a.event.props.concat(a.event.mouseHooks?a.event.mouseHooks.props:[]),t={},y=0,q=0,D=0,A=false,C=[],z=false,F=false,J="addEventListener"in b,H=a(b),K=1,E=0;a.vmouse={moveDistanceThreshold:10,clickDistanceThreshold:10,
resetTimerDuration:1500};for(var I=0;I<c.length;I++)a.event.special[c[I]]=k(c[I]);J&&b.addEventListener("click",function(b){var d=C.length,e=b.target,f,c,g,h,z;if(d){f=b.clientX;c=b.clientY;threshold=a.vmouse.clickDistanceThreshold;for(g=e;g;){for(h=0;h<d;h++)if(z=C[h],g===e&&Math.abs(z.x-f)<threshold&&Math.abs(z.y-c)<threshold||a.data(g,v)===z.touchID){b.preventDefault();b.stopPropagation();return}g=g.parentNode}}},true)})(jQuery,q,k);(function(a,c,b){function g(a){a=a||location.href;return"#"+a.replace(/^[^#]*#?(.*)$/,
"$1")}var e="hashchange",d=k,f,h=a.event.special,j=d.documentMode,p="on"+e in c&&(j===b||j>7);a.fn[e]=function(a){return a?this.bind(e,a):this.trigger(e)};a.fn[e].delay=50;h[e]=a.extend(h[e],{setup:function(){if(p)return false;a(f.start)},teardown:function(){if(p)return false;a(f.stop)}});f=function(){function f(){var b=g(),d=w(r);if(b!==r)k(r=b,d),a(c).trigger(e);else if(d!==r)location.href=location.href.replace(/#.*/,"")+d;j=setTimeout(f,a.fn[e].delay)}var h={},j,r=g(),n=function(a){return a},k=
n,w=n;h.start=function(){j||f()};h.stop=function(){j&&clearTimeout(j);j=b};a.browser.msie&&!p&&function(){var b,c;h.start=function(){if(!b)c=(c=a.fn[e].src)&&c+g(),b=a('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){c||k(g());f()}).attr("src",c||"javascript:0").insertAfter("body")[0].contentWindow,d.onpropertychange=function(){try{if(event.propertyName==="title")b.document.title=d.title}catch(a){}}};h.stop=n;w=function(){return g(b.location.href)};k=function(f,c){var g=b.document,
...
" out"+h):o();return f.promise()};a.mobile.transitionHandlers={"default":a.mobile.defaultTransitionHandler};a.mobile.transitionFallbacks={}})(jQuery,this);(function(a,c){function b(b){r&&(!r.closest(".ui-page-active").length||b)&&r.removeClass(a.mobile.activeBtnClass);r=null}function g(){w=false;s.length>0&&a.mobile.changePage.apply(null,s.pop())}function e(b,c,d,e){c&&c.data("page")._trigger("beforehide",null,{nextPage:b});b.data("page")._trigger("beforeshow",null,{prevPage:c||a("")});a.mobile.hidePageLoadingMsg();
...
c.url&&(d=a<n.activeIndex,e=!d,f=a)});this.activeIndex=f!==c?f:this.activeIndex;d?(b.either||b.isBack)(true):e&&(b.either||b.isForward)(false)},ignoreNextHashChange:false},s=[],w=false,v="&ui-state=dialog",u=o.children("base"),x=l.parseUrl(location.href),t=u.length?l.parseUrl(l.makeUrlAbsolute(u.attr("href"),x.href)):x,y=x.hrefNoHash!==t.hrefNoHash,B=a.support.dynamicBaseTag?{element:u.length?u:a("<base>",{href:t.hrefNoHash}).prependTo(o),set:function(a){B.element.attr("href",l.makeUrlAbsolute(a,
...
"hashchange",function(){D=true});m.one("pagecontainercreate",function(){a.mobile.pageContainer.bind("pagechange",function(){D=true;m.unbind("scrollstop",C);m.bind("scrollstop",C)})});m.bind("scrollstop",C);a.mobile.getScreenHeight=d;a.fn.animationComplete=function(b){return a.support.cssTransitions?a(this).one("webkitAnimationEnd animationend",b):(setTimeout(b,0),a(this))};a.mobile.path=l;a.mobile.base=B;a.mobile.urlHistory=n;a.mobile.dialogHashKey=v;a.mobile.allowCrossDomainPages=false;a.mobile.getDocumentUrl=
...
a.mobile.activePage&&p(a.mobile.activePage)||t.hrefNoHash);if(f.data&&f.type==="get")k=l.addSearchParams(k,f.data),f.data=c;if(f.data&&f.type==="post")f.reloadPage=true;var m=l.getFilePath(k),v=l.convertUrlToDataUrl(k);f.pageContainer=f.pageContainer||a.mobile.pageContainer;g=f.pageContainer.children(":jqmData(url='"+v+"')");g.length===0&&v&&!l.isPath(v)&&(g=f.pageContainer.children("#"+v).attr("data-"+a.mobile.ns+"url",v));if(g.length===0)if(a.mobile.firstPage&&l.isFirstPageUrl(m))a.mobile.firstPage.parent().length&&
(g=a(a.mobile.firstPage));else if(l.isEmbeddedPage(m))return e.reject(k,d),e.promise();B&&B.reset();if(g.length){if(!f.reloadPage)return h(g,f.role),e.resolve(k,d,g),e.promise();j=g}var n=f.pageContainer,u=new a.Event("pagebeforeload"),o={url:b,absUrl:k,dataUrl:v,deferred:e,options:f};n.trigger(u,o);if(u.isDefaultPrevented())return e.promise();if(f.showLoadMsg)var r=setTimeout(function(){a.mobile.showPageLoadingMsg()},f.loadMsgDelay);!a.mobile.allowCrossDomainPages&&!l.isSameDomain(x,k)?e.reject(k,
d):a.ajax({url:m,type:f.type,data:f.data,dataType:"html",success:function(c,n,p){var u=a("<div></div>"),t=c.match(/<title[^>]*>([^<]*)/)&&RegExp.$1,s=RegExp("\\bdata-"+a.mobile.ns+"url=[\"']?([^\"'>]*)[\"']?");RegExp("(<[^>]+\\bdata-"+a.mobile.ns+"role=[\"']?page[\"']?[^>]*>)").test(c)&&RegExp.$1&&s.test(RegExp.$1)&&RegExp.$1&&(b=m=l.getFilePath(RegExp.$1));B&&B.set(m);u.get(0).innerHTML=c;g=u.find(":jqmData(role='page'), :jqmData(role='dialog')").first();g.length||(g=a("<div data-"+a.mobile.ns+"role='page'>"+
c.split(/<\/?body[^>]*>/gmi)[1]+"</div>"));t&&!g.jqmData("title")&&(~t.indexOf("&")&&(t=a("<div>"+t+"</div>").text()),g.jqmData("title",t));if(!a.support.dynamicBaseTag){var x=l.get(m);g.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]").each(function(){var b=a(this).is("[href]")?"href":a(this).is("[src]")?"src":"action",c=a(this).attr(b),c=c.replace(location.protocol+"//"+location.host+location.pathname,"");/^(\w+:|#|\/)/.test(c)||a(this).attr(b,x+c)})}g.attr("data-"+
a.mobile.ns+"url",l.convertUrlToDataUrl(m)).attr("data-"+a.mobile.ns+"external-page",true).appendTo(f.pageContainer);g.one("pagecreate",a.mobile._bindPageRemove);h(g,f.role);k.indexOf("&"+a.mobile.subPageUrlKey)>-1&&(g=f.pageContainer.children(":jqmData(url='"+v+"')"));f.showLoadMsg&&(clearTimeout(r),a.mobile.hidePageLoadingMsg());o.xhr=p;o.textStatus=n;o.page=g;f.pageContainer.trigger("pageload",o);e.resolve(k,d,g,j)},error:function(b,c,g){B&&B.set(l.get());o.xhr=b;o.textStatus=c;o.errorThrown=g;
b=new a.Event("pageloadfailed");f.pageContainer.trigger(b,o);b.isDefaultPrevented()||(f.showLoadMsg&&(clearTimeout(r),a.mobile.hidePageLoadingMsg(),a.mobile.showPageLoadingMsg(a.mobile.pageLoadErrorMessageTheme,a.mobile.pageLoadErrorMessage,true),setTimeout(a.mobile.hidePageLoadingMsg,1500)),e.reject(k,d))}});return e.promise()};a.mobile.loadPage.defaults={type:"get",data:c,reloadPage:false,role:c,showLoadMsg:false,pageContainer:c,loadMsgDelay:50};a.mobile.changePage=function(d,f){if(w)s.unshift(arguments);
else{var j=a.extend({},a.mobile.changePage.defaults,f);j.pageContainer=j.pageContainer||a.mobile.pageContainer;j.fromPage=j.fromPage||a.mobile.activePage;var m=j.pageContainer,p=new a.Event("pagebeforechange"),o={toPage:d,options:j};m.trigger(p,o);if(!p.isDefaultPrevented())if(d=o.toPage,w=true,typeof d=="string")a.mobile.loadPage(d,j).done(function(b,c,d,f){w=false;c.duplicateCachedPage=f;a.mobile.changePage(d,c)}).fail(function(){w=false;b(true);g();j.pageContainer.trigger("pagechangefailed",o)});
else{if(d[0]===a.mobile.firstPage[0]&&!j.dataUrl)j.dataUrl=x.hrefNoHash;var p=j.fromPage,u=j.dataUrl&&l.convertUrlToDataUrl(j.dataUrl)||d.jqmData("url"),t=u;l.getFilePath(u);var r=n.getActive(),q=n.activeIndex===0,y=0,B=k.title,A=j.role==="dialog"||d.jqmData("role")==="dialog";if(p&&p[0]===d[0]&&!j.allowSamePageTransition)w=false,m.trigger("pagechange",o);else{h(d,j.role);j.fromHashChange&&n.directHashChange({currentUrl:u,isBack:function(){y=-1},isForward:function(){y=1}});try{k.activeElement&&k.activeElement.nodeName.toLowerCase()!=
"body"?a(k.activeElement).blur():a("input:focus, textarea:focus, select:focus").blur()}catch(D){}A&&r&&(u=(r.url||"")+v);if(j.changeHash!==false&&u)n.ignoreNextHashChange=true,l.set(u);var C=!r?B:d.jqmData("title")||d.children(":jqmData(role='header')").find(".ui-title").getEncodedText();C&&B==k.title&&(B=C);d.jqmData("title")||d.jqmData("title",B);j.transition=j.transition||(y&&!q?r.transition:c)||(A?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);y||n.addNew(u,j.transition,B,t,
j.role);k.title=n.getActive().title;a.mobile.activePage=d;j.reverse=j.reverse||y<0;e(d,p,j.transition,j.reverse).done(function(c,f,e,h,l){b();j.duplicateCachedPage&&j.duplicateCachedPage.remove();l||a.mobile.focusPage(d);g();m.trigger("pagechange",o)})}}}};a.mobile.changePage.defaults={transition:c,reverse:false,changeHash:true,fromHashChange:false,role:c,duplicateCachedPage:c,pageContainer:c,showLoadMsg:true,dataUrl:c,fromPage:c,allowSamePageTransition:false};a.mobile._registerInternalEvents=function(){a(k).delegate("form",
"submit",function(b){var c=a(this);if(a.mobile.ajaxEnabled&&!c.is(":jqmData(ajax='false')")&&c.jqmHijackable().length){var d=c.attr("method"),f=c.attr("target"),e=c.attr("action");if(!e&&(e=p(c),e===t.hrefNoHash))e=x.hrefNoSearch;e=l.makeUrlAbsolute(e,p(c));!l.isExternal(e)&&!f&&(a.mobile.changePage(e,{type:d&&d.length&&d.toLowerCase()||"get",data:c.serialize(),transition:c.jqmData("transition"),direction:c.jqmData("direction"),reloadPage:true}),b.preventDefault())}});a(k).bind("vclick",function(c){if(!(c.which>
...
200)};f.jqmData("href")&&f.attr("href",f.jqmData("href"));if(f.is(":jqmData(rel='back')"))return q.history.back(),false;var h=p(f),e=l.makeUrlAbsolute(f.attr("href")||"#",h);if(!a.mobile.ajaxEnabled&&!l.isEmbeddedPage(e))g();else{if(e.search("#")!=-1)if(e=e.replace(/[^#]*#/,""))e=l.isPath(e)?l.makeUrlAbsolute(e,h):l.makeUrlAbsolute("#"+e,x.hrefNoHash);else{d.preventDefault();return}var h=f.is("[rel='external']")||f.is(":jqmData(ajax='false')")||f.is("[target]"),k=a.mobile.allowCrossDomainPages&&x.protocol===
...
j=this._getChildrenByTagName(e[0],"li","LI"),p=a.support.cssPseudoElement||!a.nodeName(e[0],"ol")?0:1,m={},o,l,r,n,s;p&&e.find(".ui-li-dec").remove();if(!c.theme)c.theme=a.mobile.getInheritedTheme(this.element,"c");for(var q=0,v=j.length;q<v;q++){o=j.eq(q);l="ui-li";if(b||!o.hasClass("ui-li"))r=o.jqmData("theme")||c.theme,n=this._getChildrenByTagName(o[0],"a","A"),n.length?(s=o.jqmData("icon"),o.buttonMarkup({wrapperEls:"div",shadow:false,corners:false,iconpos:"right",icon:n.length>1||s===false?false:
...
"",s=this.options.mini||g.jqmData("mini")?" ui-slider-mini":"",w=k.createElement("a"),v=a(w),u=k.createElement("div"),x=a(u),t=g.jqmData("highlight")&&f!="select"?function(){var b=k.createElement("div");b.className="ui-slider-bg ui-btn-active ui-btn-corner-all";return a(b).prependTo(x)}():false;u.setAttribute("role","application");u.className=["ui-slider ",h," ui-btn-down-",e," ui-btn-corner-all",n,s].join("");w.className="ui-slider-handle";u.appendChild(w);v.buttonMarkup({corners:true,theme:d,shadow:true}).attr({role:"slider",
"aria-valuemin":o,"aria-valuemax":l,"aria-valuenow":m(),"aria-valuetext":m(),title:m(),"aria-labelledby":p});a.extend(this,{slider:x,handle:v,valuebg:t,dragging:false,beforeStart:null,userModified:false,mouseMoved:false});if(f=="select"){d=k.createElement("div");d.className="ui-slider-inneroffset";h=0;for(p=u.childNodes.length;h<p;h++)d.appendChild(u.childNodes[h]);u.appendChild(d);v.addClass("ui-slider-handle-snapping");u=g.find("option");d=0;for(h=u.length;d<h;d++)p=!d?"b":"a",n=!d?" ui-btn-down-"+
e:" "+a.mobile.activeBtnClass,k.createElement("div"),s=k.createElement("span"),s.className=["ui-slider-label ui-slider-label-",p,n," ui-btn-corner-all"].join(""),s.setAttribute("role","img"),s.appendChild(k.createTextNode(u[d].innerHTML)),a(s).prependTo(x);b._labels=a(".ui-slider-label",x)}j.addClass("ui-slider");g.addClass(f==="input"?"ui-slider-input":"ui-slider-switch").change(function(){b.mouseMoved||b.refresh(m(),true)}).keyup(function(){b.refresh(m(),true,true)}).blur(function(){b.refresh(m(),
true)});a(k).bind("vmousemove",function(a){if(b.dragging)return b.mouseMoved=true,f==="select"&&v.removeClass("ui-slider-handle-snapping"),b.refresh(a),b.userModified=b.beforeStart!==g[0].selectedIndex,false});x.bind("vmousedown",function(a){b.dragging=true;b.userModified=false;b.mouseMoved=false;if(f==="select")b.beforeStart=g[0].selectedIndex;b.refresh(a);return false});x.add(k).bind("vmouseup",function(){if(b.dragging)return b.dragging=false,f==="select"&&(v.addClass("ui-slider-handle-snapping"),
b.mouseMoved?b.userModified?b.refresh(b.beforeStart==0?1:0):b.refresh(b.beforeStart):b.refresh(b.beforeStart==0?1:0)),b.mouseMoved=false});x.insertAfter(g);f=="select"&&this.handle.bind({focus:function(){x.addClass(a.mobile.focusClass)},blur:function(){x.removeClass(a.mobile.focusClass)}});this.handle.bind({vmousedown:function(){a(this).focus()},vclick:false,keydown:function(c){var d=m();if(!b.options.disabled){switch(c.keyCode){case a.mobile.keyCode.HOME:case a.mobile.keyCode.END:case a.mobile.keyCode.PAGE_UP:case a.mobile.keyCode.PAGE_DOWN:case a.mobile.keyCode.UP:case a.mobile.keyCode.RIGHT:case a.mobile.keyCode.DOWN:case a.mobile.keyCode.LEFT:if(c.preventDefault(),
...
d=this.isMultiple?"checkbox-off":"false";this.list.empty().filter(".ui-listview").listview("destroy");var e=this.select.find("option"),f=e.length,g=this.select[0],h="data-"+a.mobile.ns,j=h+"option-index",l=h+"icon";h+="role";for(var m=k.createDocumentFragment(),n,p=0;p<f;p++){var o=e[p],q=a(o),r=o.parentNode,s=q.text(),w=k.createElement("a");classes=[];w.setAttribute("href","#");w.appendChild(k.createTextNode(s));r!==g&&r.nodeName.toLowerCase()==="optgroup"&&(r=r.getAttribute("label"),r!=n&&(n=k.createElement("li"),
n.setAttribute(h,"list-divider"),n.setAttribute("role","option"),n.setAttribute("tabindex","-1"),n.appendChild(k.createTextNode(r)),m.appendChild(n),n=r));if(!c&&(!o.getAttribute("value")||s.length==0||q.jqmData("placeholder")))b.hidePlaceholderMenuItems&&classes.push("ui-selectmenu-placeholder"),c=this.placeholder=s;q=k.createElement("li");o.disabled&&(classes.push("ui-disabled"),q.setAttribute("aria-disabled",true));q.setAttribute(j,p);q.setAttribute(l,d);q.className=classes.join(" ");q.setAttribute("role",
"option");q.setAttribute("tabindex","-1");q.appendChild(w);m.appendChild(q)}m.firstChild.setAttribute("tabindex",0);this.list[0].appendChild(m);this.isMultiple||this.headerClose.hide();!this.isMultiple&&!c.length?this.header.hide():this.headerTitle.text(this.placeholder);this.list.listview()},_button:function(){return a("<a>",{href:"#",role:"button",id:this.buttonId,"aria-haspopup":"true","aria-owns":this.menuId})}})};a(k).delegate("select","selectmenubeforecreate",function(){var b=a(this).data("selectmenu");
