...
if (!String.prototype.trim) {
  ...
  module.exports = (function(_super) {
    ...
    function exports() {
      ...
      pollLoop = null;
      this.zhongwen_input.bind('focus', function() {
        return pollLoop = setInterval(_this._updateProgress, 1000);
      });
      this.zhongwen_input.bind('blur', function() {
    ...
    */
    ...
    exports.prototype._selectSuggestion = function(char) {
      if (!this.suggestions.is(":visible")) return;
      if ("number" === typeof char) {
        char = $("td:eq(" + char + ") span.char", this.suggestions);
        if (0 === char.size()) return;
        char = char.text();
      }
      this._insertAtCaret(this.zhongwen_input.get(0), char);
    ...
    */
    ...
    exports.prototype._updateSuggestions = function(chars) {
      ...
      if (0 < chars.length) {
        ...
        $("td", this.suggestions).each(function(i, e) {
          return $(e).bind('vclick', function() {
            return _this._selectSuggestion($(".char", e).text());
          });
        });
  ...
  var Sentence, SentenceBuilder, Unit_5, Units_1_To_4, data,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  Unit_5 = (function(_super) {

    __extends(Unit_5, _super);
    ...
    Unit_5.prototype.next = function() {
      var s;
      s = this._sentences[parseInt(Math.random() * this._sentences.length)];
      return {
        en: s[0],
    ...
    Unit_5.prototype.shortDesc = function() {
      return "Unit 5";
    };
...
}, "dict": function(exports, require, module) {
/*
...
(function() {
  ...
  */
  ...
  changeTone = function(pinyin, newTone) {
    ...
    i = -1;
    vowels = [['ā', 'á', 'ǎ', 'à', 'a'], ['ē', 'é', 'ě', 'è', 'e'], ['ī', 'í', 'ǐ', 'ì', 'i'], ['ō', 'ó', 'ǒ', 'ò', 'o'], ['ū', 'ú', 'ǔ', 'ù', 'u'], ['ǖ', 'ǘ', 'ǚ', 'ǜ', 'u']];
